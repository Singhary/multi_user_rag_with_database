...
SCHEMA_PATH = Path('c:/Users/singh/Desktop/multi_user_rag/api/prisma/schema.prisma')
PACKAGED_SCHEMA_PATH = Path(__file__).parent.joinpath('schema.prisma')
ENGINE_TYPE: EngineType = EngineType.binary
BINARY_PATHS = model_parse(BinaryPaths, {'queryEngine': {'windows': 'C:\\Users\\singh\\.cache\\prisma-python\\binaries\\5.17.0\\393aa359c9ad4a4bb28630fb5613f9c281cde053\\node_modules\\prisma\\query-engine-windows.exe'}, 'introspectionEngine': {}, 'migrationEngine': {}, 'libqueryEngine': {}, 'prismaFmt': {}})
...
class Prisma(AsyncBasePrisma):
    ...
    application_logs: 'actions.Application_logsActions[models.Application_logs]'
    document_store: 'actions.Document_storeActions[models.Document_store]'
    ...
    def __init__(
        ...
        *,
        ...
        self.application_logs = actions.Application_logsActions[models.Application_logs](self, models.Application_logs)
        self.document_store = actions.Document_storeActions[models.Document_store](self, models.Document_store)
    ...
    def _default_datasource(self) -> Datasource:
        return {
            ...
            'source_file_path': 'c:/Users/singh/Desktop/multi_user_rag/api/prisma/schema.prisma',
        }
...
class Batch:
    application_logs: 'Application_logsBatchActions'
    document_store: 'Document_storeBatchActions'

    def __init__(self, client: Prisma) -> None:
        self.__client = client
        self.__queries: List[str] = []
        self._active_provider = client._active_provider
        self.application_logs = Application_logsBatchActions(self)
        self.document_store = Document_storeBatchActions(self)
...
class Application_logsBatchActions:
...
# NOTE: some arguments are meaningless in this context but are included
# for completeness sake
class Document_storeBatchActions:
    def __init__(self, batcher: Batch) -> None:
        self._batcher = batcher
